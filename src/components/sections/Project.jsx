                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredProjects.map((project) => (
                        <motion.div
                            ...
                            transition={{ duration: 0.5, delay: project.id * 0.1 }} // Simple delay or use grid stagger
                            className="bg-gray-800/50 backdrop-blur-sm rounded-lg overflow-hidden border border-gray-700/50 hover:border-pink-500/50 transition-colors duration-300 group"
                        >
                ...
                <RevealOnScroll>
                    <div className="text-center mt-16">
                        ...
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="inline-block px-8 py-3 bg-gradient-to-r from-pink-500 to-pink-600 text-white font-semibold rounded-lg hover:from-pink-600 hover:to-pink-700 transition-all duration-300 shadow-lg hover:shadow-pink-500/25"
                        >
                            Get In Touch
                        </motion.a>
                    </div>
